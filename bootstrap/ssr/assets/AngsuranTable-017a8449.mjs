...
import Action from "./Action-12a32aea.mjs";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative overflow-auto h-[60vh] lg:h-[85vh]", children: [
    /* @__PURE__ */ jsxs(Table, { className: "text-xs rounded-lg", children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: data ? data.map((row, i) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
        /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 16 + (dateOfWeek.length ?? 0), children: row.month }) }),
        row.data.map((subrow, i2) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: subrow.nik }),
          ...
          /* @__PURE__ */ jsx(TableCell, { children: subrow.kelompok }),
          /* @__PURE__ */ jsx(TableCell, { children: subrow.hari }),
          /* @__PURE__ */ jsx(TableCell, { children: subrow.pinjaman_ke }),
          /* @__PURE__ */ jsx(TableCell, { children: subrow.x_angs }),
        ...
        /* @__PURE__ */ jsxs(TableRow, { className: "bg-gray-100", children: [
          /* @__PURE__ */ jsx(TableCell, { className: "py-3", colSpan: 9, children: "ini nanti total" }),
