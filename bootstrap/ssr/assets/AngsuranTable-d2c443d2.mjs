    ...
    /* @__PURE__ */ jsxs(Table, { className: "text-xs rounded-lg", children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: data ? data.map((row, i) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
        ...
        row.data.map((subrow, i2) => /* @__PURE__ */ jsxs(
          TableRow,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(TableCell, { className: "bg-slate-200 border-x border-x-black", children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow.pinjaman }) }),
              /* @__PURE__ */ jsx(TableCell, { className: "bg-blue-300 border-x border-x-black", children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow.saldo_sebelumnya }) }),
              ...
              /* @__PURE__ */ jsx(TableCell, { className: "bg-yellow-200 border-x border-x-black", children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow.angsuran }) }),
              /* @__PURE__ */ jsx(TableCell, { className: "bg-green-300 border-x border-x-black", children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow.saldo }) }),
        ...
        /* @__PURE__ */ jsxs(TableRow, { className: "bg-gray-100", children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "bg-slate-200 border-x border-x-black", children: /* @__PURE__ */ jsx(
            FormatNumbering,
            {
              value: calculateTotals(row.data, "pinjaman")
            }
          ) }),
          /* @__PURE__ */ jsx(TableCell, { className: "bg-blue-300 border-x border-x-black", children: /* @__PURE__ */ jsx(
            FormatNumbering,
            {
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "bg-yellow-200 border-x border-x-black", children: /* @__PURE__ */ jsx(
            FormatNumbering,
            {
              value: calculateTotals(row.data, "angsuran")
            }
          ) }),
          /* @__PURE__ */ jsx(TableCell, { className: "bg-green-300 border-x border-x-black", children: /* @__PURE__ */ jsx(
            FormatNumbering,
            {
