...
const MobileLayout = ({ header, children, loading = false }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative z-10 antialiased", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative h-screen px-2 mx-auto lg:px-4", children: [
      /* @__PURE__ */ jsx("div", { className: "sticky top-0 z-50 flex items-center h-16 gap-4 px-3 bg-transparent", children: /* @__PURE__ */ jsxs("nav", { className: "flex flex-row items-center justify-between w-full gap-5 text-sm font-mediumlg:gap-6 backdrop-blur", children: [
