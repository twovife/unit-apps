...
function LinkButton({
  ...
  return /* @__PURE__ */ jsx(
    Link,
    {
      ...
      as,
      type,
      className: `inline-flex items-center ${sizeButton()} py-2 px-4 border rounded-md font-semibold text-xs uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150 ${disabled && "opacity-25"}` + className,
      disabled,
