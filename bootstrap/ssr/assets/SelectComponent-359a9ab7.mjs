...
function useOptionGenerator({ propsWilayah = "", ...props } = {}) {
  ...
  useEffect(() => {
    var _a, _b;
    const branchFiltered = selectedWilayah !== "" ? (_b = (_a = server_filter == null ? void 0 : server_filter.branch) == null ? void 0 : _a.filter((item) => {
  ...
  useEffect(() => {
    var _a, _b;
    const employeeFiltered = selectedBranch_id !== "" ? (_b = (_a = server_filter == null ? void 0 : server_filter.employees) == null ? void 0 : _a.filter((item) => {
