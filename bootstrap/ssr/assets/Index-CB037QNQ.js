...
import { M as MobileLayout } from "./MobileLayout-COPh3ryR.js";
import { B as Button } from "./button-MTjEwktD.js";
import "./card-WipCscFv.js";
import { usePage, Link } from "@inertiajs/react";
import { MagnifyingGlassIcon } from "@radix-ui/react-icons";
import { Layers, HandCoinsIcon, UserX, BookMarked } from "lucide-react";
import "react";
import "./AuthenticatedLayout-BEPqRHWf.js";
  ...
  return /* @__PURE__ */ jsxs(MobileLayout, { children: [
    ...
    auth.permissions.includes("can update") && /* @__PURE__ */ jsxs("fieldset", { className: "grid gap-6 p-4 mt-3 border rounded-lg", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-around gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx(Button, { size: "icon2xl", variant: "outline", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: route("transaction.index_buku_transaksi"), children: /* @__PURE__ */ jsx(BookMarked, { className: "h-7 w-7" }) }) }),
