  ...
  const filterModal = () => {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "bg-white border border-gray-300 rounded-lg shadow-lg max-w-full w-full", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-end items-center text-2xl px-2 py-4 flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col-reverse", children: [
            ...
            /* @__PURE__ */ jsx("label", { className: "text-gray-400 text-xs font-semibold peer-focus/column:text-blue-500", children: "Kolom" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col-reverse", children: [
            /* @__PURE__ */ jsxs(
              "select",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col-reverse", children: [
            ...
            /* @__PURE__ */ jsx("label", { className: "text-gray-400 text-xs font-semibold peer-focus/value:text-blue-500", children: "Kata Kunci" })
          ] }),
    ...
    Authenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 flex justify-end items-center gap-3 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white text-slate-700 ring-1 ring-slate-700 ring-opacity-5 shadow px-6 py-4 rounded-md", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mx-auto mb-6 ring-1 ring-black ring-opacity-5 rounded shadow max-h-screen", children: /* @__PURE__ */ jsx("div", { className: "overflow-auto max-h-[70vh]", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-xs text-left text-gray-500 relative", children: [
              /* @__PURE__ */ jsx("thead", { className: "text-gray-900 uppercase sticky top-0 whitespace-nowrap z-50", children: /* @__PURE__ */ jsxs("tr", { className: "bg-gray-200 text-center", children: [
                /* @__PURE__ */ jsx("th", { className: "lg:sticky left-0 top-0 z-40 bg-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-start items-start gap-1 w-96", children: [
                  /* @__PURE__ */ jsxs(
                    "div",
                    {
              ...
              /* @__PURE__ */ jsx("tbody", { children: displayData && displayData.map((item, key) => /* @__PURE__ */ jsxs(
                "tr",
                {
                  className: "bg-white even:bg-gray-100",
                  children: [
                    /* @__PURE__ */ jsx("td", { className: "lg:sticky left-0 top-0 z-40 bg-inherit", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-start items-start gap-1", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex-1 py-1 px-4 flex justify-between items-center w-full", children: [
                        /* @__PURE__ */ jsxs("div", { className: "bg-red-100", children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "relative z-30", children: /* @__PURE__ */ jsx("div", { className: "flex items-start justify-evenly w-36", children: /* @__PURE__ */ jsx("div", { className: "flex-1 py-1 px-4", children: item.nik_customer }) }) }),
