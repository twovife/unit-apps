...
import BayarAngsuran from "./BayarAngsuran-14e0245b.mjs";
import JenisNasabah from "./JenisNasabah-6b84efb3.mjs";
import DeleteAngsuran from "./DeleteAngsuran-eb44066f.mjs";
import DeleteLoan from "./DeleteLoan-b7aabb1d.mjs";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col w-full gap-3 mt-3 lg:flex-row", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-[2]", children: [
            ...
            auth.permissions.includes("unit pimpinan") && /* @__PURE__ */ jsxs(Fragment, { children: [
