...
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent, c as CardDescription } from "./card-f356ad44.mjs";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-c148af71.mjs";
import axios from "axios";
import RiwayatPengajuan from "./RiwayatPengajuan-aa3b808c.mjs";
import Acc from "./Acc-711e7371.mjs";
import ActionTable from "./ActionTable-0d5c3717.mjs";
import RemoveLoan from "./RemoveLoan-10a666cf.mjs";
import "./Loading-95bc2f77.mjs";
import "./button-e7ccf50f.mjs";
import "./label-7289427a.mjs";
import "@inertiajs/react";
import ChangeDetail from "./ChangeDetail-387ac0d8.mjs";
...
const Action = ({ show = false, onClosed, triggeredData }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Dialog, { open: show, onOpenChange: (open) => open ? "" : onClosed(), children: /* @__PURE__ */ jsxs(DialogContent, { className: "w-[95vw] h-auto px-1 overflow-hidden", children: [
    ...
    loading ? /* @__PURE__ */ jsx("div", { children: "Data Sedang Dimuat" }) : /* @__PURE__ */ jsxs(DialogHeader, { children: [
      ...
      /* @__PURE__ */ jsx(DialogDescription, { children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "account", className: "w-full h-max", children: [
        /* @__PURE__ */ jsxs(TabsList, { className: "grid w-full grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsx(TabsTrigger, { value: "historylain", children: "Crash UBM" })
        ] }),
        /* @__PURE__ */ jsxs(
          TabsContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs(Card, { children: [
                ...
                /* @__PURE__ */ jsx(CardContent, { className: "p-1 space-y-2", children: /* @__PURE__ */ jsx("div", { className: "overflow-auto border rounded-lg scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-thin", children: /* @__PURE__ */ jsx(ActionTable, { datas: data }) }) })
              ] }),
        ...
        /* @__PURE__ */ jsx(TabsContent, { value: "history", children: /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "p-1 space-y-2", children: /* @__PURE__ */ jsx("div", { className: "h-[50vh] border rounded-lg overflow-auto scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-thin", children: /* @__PURE__ */ jsx(
            RiwayatPengajuan,
            {
              data: customerData == null ? void 0 : customerData.history_branch
            }
          ) }) })
        ] }) }),
        /* @__PURE__ */ jsx(TabsContent, { value: "historylain", children: /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsx(CardTitle, { children: "Riwayat Pengajuan" }),
            /* @__PURE__ */ jsx(CardDescription, { children: "Riwayat Pengajuan Nasabah dilihat berdasarkan NIK yang tertera dari semua cabang" })
          ] }),
          /* @__PURE__ */ jsx(CardContent, { className: "p-1 space-y-2", children: /* @__PURE__ */ jsx("div", { className: "h-[50vh] border rounded-lg overflow-auto scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-thin", children: /* @__PURE__ */ jsx(RiwayatPengajuan, { data: customerData == null ? void 0 : customerData.history_lain }) }) })
        ] }) })
      ] }) })
    ] })
  ] }) }) });
