  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative overflow-auto h-[60vh] lg:h-[85vh] scrollbar-thin", children: [
    /* @__PURE__ */ jsxs(Table, { className: "text-xs rounded-lg", children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: data ? data.map((row, i) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
        ...
        row.data.map((subrow2, i2) => /* @__PURE__ */ jsxs(
          TableRow,
          {
            className: `${selectedId.includes(subrow2.id) ? "bg-green-200 hover:bg-green-50" : ""}}`,
            children: [
              /* @__PURE__ */ jsx(TableCell, { onClick: () => handleRowClick(subrow2.id), children: i2 + 1 }),
              /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                /* @__PURE__ */ jsx("div", { children: dayjs(subrow2.tanggal_drop).format("DD-MM") }),
                /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
                  Button,
                  {
                    size: "xs",
                    onClick: () => onCreateShowOpen(subrow2.id),
                    children: "Pay"
                  }
                ) })
              ] }) }),
              /* @__PURE__ */ jsx(TableCell, { children: subrow2.nama }),
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: subrow2.nik }),
              /* @__PURE__ */ jsxs(TableCell, { className: "text-center", children: [
                subrow2.lunas ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 mr-1 text-xs text-white bg-green-400 border rounded", children: "Lunas" }) : "",
                subrow2.status_pinjaman == "normal" ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 mr-1 text-xs border rounded", children: subrow2.status_pinjaman }) : subrow2.status_pinjaman == "cm" ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 mr-1 text-xs text-white bg-yellow-400 border rounded", children: subrow2.status_pinjaman }) : subrow2.status_pinjaman == "mb" ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 mr-1 text-xs text-white bg-red-400 border rounded", children: subrow2.status_pinjaman }) : subrow2.status_pinjaman == "ml" ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 mr-1 text-xs text-white bg-black border rounded", children: subrow2.status_pinjaman }) : /* @__PURE__ */ jsx("div", { children: subrow2.status_pinjaman }),
                subrow2.notes !== null ? /* @__PURE__ */ jsx(Badge, { children: subrow2.notes }) : ""
              ] }),
              /* @__PURE__ */ jsx(TableCell, { children: subrow2.alamat }),
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: subrow2.kelompok }),
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: subrow2.hari }),
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: subrow2.pinjaman_ke }),
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: subrow2.x_angs }),
              /* @__PURE__ */ jsx(
                TableCell,
                {
                  className: `bg-slate-200 hover:bg-slate-100 border-x border-x-black ${selectedId.includes(subrow2.id) ? "bg-green-200 hover:bg-green-50" : ""}`,
                  children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow2.pinjaman })
                }
              ),
              /* @__PURE__ */ jsx(
                TableCell,
                {
                  className: `bg-blue-300 hover:bg-blue-100 border-x border-x-black ${selectedId.includes(subrow2.id) ? "bg-green-200 hover:bg-green-50" : ""}`,
                  children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow2.saldo_sebelumnya })
                }
              ),
              dateOfWeek.map((day, i3) => /* @__PURE__ */ jsx(TableCell, { className: "border-x border-x-black", children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow2.instalment[day] }) }, i3)),
              /* @__PURE__ */ jsx(
                TableCell,
                {
                  className: `bg-yellow-200 hover:bg-yellow-100 border-x border-x-black ${selectedId.includes(subrow2.id) ? "bg-green-200 hover:bg-green-50" : ""}`,
                  children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow2.angsuran })
                }
              ),
              /* @__PURE__ */ jsx(
                TableCell,
                {
                  className: `bg-green-300 hover:bg-green-100 border-x border-x-black ${selectedId.includes(subrow2.id) ? "bg-green-200 hover:bg-green-50" : ""}`,
                  children: /* @__PURE__ */ jsx(FormatNumbering, { value: subrow2.saldo })
                }
              ),
              /* @__PURE__ */ jsx(TableCell, { children: subrow2.notes })
            ]
          },
          i2
        )),
