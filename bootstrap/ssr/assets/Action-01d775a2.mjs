...
import BayarAngsuran from "./BayarAngsuran-61aaa747.mjs";
import JenisNasabah from "./JenisNasabah-6217c9b1.mjs";
import DeleteAngsuran from "./DeleteAngsuran-86487c4b.mjs";
import DeleteLoan from "./DeleteLoan-7dad4029.mjs";
...
const Action = ({ datas, show = false, onClosed, triggeredId }) => {
  ...
  return /* @__PURE__ */ jsx(Dialog, { open: show, onOpenChange: (open) => open ? "" : modalIsClosed(), children: /* @__PURE__ */ jsxs(
    DialogContent,
    {
      className: `w-[90vw] h-[90vh] overflow-auto scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-thin p-2`,
      children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "w-full", children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "overflow-auto scrollbar-thin", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col w-full gap-3 mt-3 lg:flex-row", children: [
          /* @__PURE__ */ jsxs(Card, { className: "flex-[5]", children: [
            /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Rincian Pinjaman" }) }),
            /* @__PURE__ */ jsx(CardContent, { className: "p-2", children: /* @__PURE__ */ jsxs(Table, { className: "text-xs", children: [
              /* @__PURE__ */ jsx(TableHeader, { className: "bg-gray-200", children: /* @__PURE__ */ jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsx(TableBody, { children: Object.keys(customerData).length !== 0 ? instalment.map((item) => /* @__PURE__ */ jsxs(TableRow, { className: "text-center", children: [
                ...
                /* @__PURE__ */ jsx(TableCell, { children: dayjs(item.transaction_date).format("DD-MM-YY") }),
                /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: `${item.danatitipan == "true" ? "text-red-500" : "text-black"}`,
                ...
                /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(StatusPinjaman, { value: item.status }) })
              ] })) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { children: "Menunggu data . . ." }) }) })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-[2]", children: [
            ...
            auth.permissions.includes("can update") && /* @__PURE__ */ jsxs(Fragment, { children: [
