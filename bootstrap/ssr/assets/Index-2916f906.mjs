...
import { M as MobileLayout } from "./MobileLayout-56afa4f8.mjs";
import { Head, Link } from "@inertiajs/react";
import { useState } from "react";
import { IoPersonAddSharp } from "react-icons/io5";
import { BiMoneyWithdraw, BiMoney, BiExit } from "react-icons/bi";
          ...
          /* @__PURE__ */ jsxs(
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-center leading-tight", children: "Daftar Drop" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(Link, { className: "w-32 h-32 rounded p-3 flex flex-col justify-center items-center shadow hover:shadow-md focus:shadow-lg bg-gray-50/40 backdrop-blur border border-gray-200", children: [
