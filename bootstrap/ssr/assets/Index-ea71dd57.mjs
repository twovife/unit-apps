      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white text-slate-700 ring-1 ring-slate-700 ring-opacity-5 shadow px-6 py-4 rounded-md", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mx-auto mb-6 ring-1 ring-black ring-opacity-5 rounded shadow max-h-screen", children: /* @__PURE__ */ jsx("div", { className: "overflow-auto max-h-[70vh]", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-xs text-left text-gray-500 relative mr-[30vw]", children: [
              ...
              /* @__PURE__ */ jsx("tbody", { children: displayData && displayData.map((item, key) => /* @__PURE__ */ jsxs("tr", { className: "bg-white", children: [
                /* @__PURE__ */ jsx("td", { className: "sticky left-0 top-0 z-40 bg-inherit", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-evenly w-[25vw]", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 flex gap-3 justify-evenly items-center py-1 px-4", children: [
                    /* @__PURE__ */ jsx("div", { children: item.nomor_pinjaman }),
                    /* @__PURE__ */ jsx(
                      Link,
                      {
                        href: route(
                ...
                /* @__PURE__ */ jsx("td", { className: "relative z-30", children: /* @__PURE__ */ jsx("div", { className: "flex items-start justify-evenly w-36", children: /* @__PURE__ */ jsxs("div", { className: "flex-1 py-1 px-4", children: [
                  ...
                  item.status == "normal" ? /* @__PURE__ */ jsx("span", { className: "mr-1 px-2 py-1 text-xs border rounded", children: item.status }) : item.status == "cm" ? /* @__PURE__ */ jsx("span", { className: "mr-1 px-2 py-1 text-xs border rounded bg-yellow-400 text-white", children: item.status }) : item.status == "mb" ? /* @__PURE__ */ jsx("span", { className: "mr-1 px-2 py-1 text-xs border rounded bg-red-400 text-white", children: item.status }) : item.status == "ml" ? /* @__PURE__ */ jsx("span", { className: "mr-1 px-2 py-1 text-xs border rounded bg-black-400 text-white", children: item.status }) : ""
                ] }) }) }),
