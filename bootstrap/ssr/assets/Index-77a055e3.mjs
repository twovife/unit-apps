  ...
  return /* @__PURE__ */ jsxs(MobileLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("fieldset", { className: "grid gap-6 p-4 mt-3 border rounded-lg", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-around gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx(Button, { size: "icon2xl", variant: "outline", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "#", children: /* @__PURE__ */ jsx(BookCheck, { className: "h-7 w-7" }) }) }),
          /* @__PURE__ */ jsx("div", { children: "Buku Storting" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx(Button, { size: "icon2xl", variant: "outline", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "#", children: /* @__PURE__ */ jsx(BookMarked, { className: "h-7 w-7" }) }) }),
