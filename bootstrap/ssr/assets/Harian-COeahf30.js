  ...
  return /* @__PURE__ */ jsxs(TableRow, { className: beku ? "bg-slate-50" : "", children: [
    ...
    /* @__PURE__ */ jsxs(
      TableCell,
      {
        ...
        title: d.angka_hidup ? "dihitung saat ini, belum ditetapkan" : void 0,
        children: [
          rupiah(d.drop),
          d.angka_hidup && /* @__PURE__ */ jsx("span", { className: "ml-1 text-slate-300", children: "~" })
        ]
      }
    ),
    /* @__PURE__ */ jsxs(TableCell, { className: "text-right tabular-nums", children: [
      rupiah(d.storting),
      d.angka_hidup && /* @__PURE__ */ jsx("span", { className: "ml-1 text-slate-300", children: "~" })
    ] }),
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-3 text-xs border rounded-lg border-slate-200 bg-slate-50 text-slate-600", children: [
        ...
        " di kolom terakhir adalah jarak antara uang yang benar-benar diserahkan mantri dengan tunai hasil rumus. Tanda",
        " ",
        /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "~" }),
        " berarti angkanya dihitung saat halaman dibuka dan ",
        /* @__PURE__ */ jsx("b", { children: "belum ditetapkan" }),
        " — yang menetapkannya adalah tombol Kunci."
      ] })
    ] }),
