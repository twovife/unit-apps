...
const RemoveLoan = ({ triggeredId, onClosed, triggeredData }) => {
  ...
  const sudahDiajukanPengganti = triggeredData == null ? void 0 : triggeredData.sudah_diajukan_pengganti;
  ...
  if (sudahDiajukanPengganti) {
    bolehHapus = false;
    pesanTerkunci = "Transaksi ini sudah diajukan (jadi dasar pengajuan/Tundaan lain yang masih berjalan), tidak bisa dihapus.";
