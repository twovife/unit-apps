  ...
  "inline-flex items-center rounded-md border font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        green: "border-transparent bg-green-500 text-white shadow-sm hover:bg-green-500/80",
        yellow: "border-transparent bg-yellow-500 text-white shadow-sm hover:bg-yellow-500/80",
        ...
        greenoutline: "border-green-500 bg-transparent text-green-500 shadow-sm hover:border-green-500/80 hover:text-green-500/80",
