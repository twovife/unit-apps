...
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent, c as CardDescription } from "./card-a7cc8935.mjs";
...
import { u as useFrontEndPermission, A as Acc, N as NoEditOverlay } from "./Acc-d35f87eb.mjs";
        ...
        /* @__PURE__ */ jsxs(TabsContent, { value: "account", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 mt-3 lg:flex-row", children: [
            /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
              /* @__PURE__ */ jsxs(Card, { className: "mb-3 relative", children: [
            ...
            /* @__PURE__ */ jsxs(Card, { className: "w-full relative", children: [
              !isCreator && /* @__PURE__ */ jsx(NoEditOverlay, { value: "User Tidak Dapat Digunakan Untuk Mengedit" }),
