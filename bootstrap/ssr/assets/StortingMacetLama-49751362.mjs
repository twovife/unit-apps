...
import "lucide-react";
const StortingMacetLama = ({ data, server_filters, ...props }) => {
  const {
    serverFilters,
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-auto rounded shadow-lg max-h-[50vh] border-b-2 border-2 border-white/50", children: /* @__PURE__ */ jsxs("table", { className: "text-sm w-full border", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: data && filterTransactions().map((item, key) => /* @__PURE__ */ jsxs(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("td", { className: "px-2 py-1", children: /* @__PURE__ */ jsx("div", { className: "mb-1 italic font-light", children: /* @__PURE__ */ jsx("span", { className: "capitalize", children: item.tanggal_drop ? dayjs(
                  item.tanggal_drop
                ).format("DD-MM") : "" }) }) }),
