...
import JenisNasabah from "./JenisNasabah-656c5aa5.mjs";
import ModalHapus from "./ModalHapus-463475d3.mjs";
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-white text-slate-700 ring-1 ring-slate-700 ring-opacity-5 shadow px-6 py-4 rounded-md", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "overflow-hidden mb-3 rounded border border-black/5 shadow p-4", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left text-gray-500", children: [
                ...
                /* @__PURE__ */ jsx("tbody", { children: loan ? /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-3 lg:flex justify-between w-full gap-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-3 flex-[2] ", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "overflow-hidden mb-3 rounded border border-black/5 shadow p-4", children: /* @__PURE__ */ jsx("div", { className: "max-h-[50vh] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left text-gray-500", children: [
                  /* @__PURE__ */ jsx("thead", { className: "text-xs text-gray-900 uppercase bg-gray-200 sticky top-0 whitespace-nowrap z-20", children: /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("tbody", { className: "relative z-10", children: instalment ? instalment.map(
                    (item, key) => /* @__PURE__ */ jsxs(
                      "tr",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-start items-center gap-4 text-blue-500", children: [
                            /* @__PURE__ */ jsx("div", { children: item.status }),
