...
const StockTakeMl = ({ datas = [], ringkasan, server_filter }) => {
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-4", children: [
      ...
      (server_filter == null ? void 0 : server_filter.periode_mundur) && /* @__PURE__ */ jsxs("div", { className: "p-3 text-xs border rounded-lg border-amber-300 bg-amber-50 text-amber-900", children: [
        /* @__PURE__ */ jsxs("b", { children: [
          dayjs(server_filter.periode_diminta).format("MMMM YYYY"),
          " belum punya baris sirkulasi"
        ] }),
        " ",
        "— belum ada kelompok yang menutup buku bulan sebelumnya. Yang ditampilkan di bawah periode",
        " ",
        /* @__PURE__ */ jsx("b", { children: dayjs(server_filter.periode).format("MMMM YYYY") }),
