...
import RiwayatPengajuan from "./RiwayatPengajuan-fa358953.mjs";
...
import Acc from "./Acc-ed0ce8f3.mjs";
import Tolak from "./Tolak-57ea4219.mjs";
import DropJadi from "./DropJadi-7429db17.mjs";
import Gagal from "./Gagal-2f4e643d.mjs";
...
import "lucide-react";
import "./DetailRiwayat-ce869871.mjs";
...
function detailTable(data) {
  return /* @__PURE__ */ jsxs(Table, { children: [
    ...
    data && /* @__PURE__ */ jsx(TableBody, { children: /* @__PURE__ */ jsxs(TableRow, { className: "text-center", children: [
      /* @__PURE__ */ jsx(TableCell, { className: "bg-red-200", children: data.tanggal_pengajuan }),
