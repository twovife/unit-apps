...
import Gagal from "./Gagal-a001072b.mjs";
import DetailTableOnAction from "./DetailTableOnAction-64a3df07.mjs";
import RemoveLoan from "./RemoveLoan-e39cef8f.mjs";
import ReStatus from "./ReStatus-01ffcaad.mjs";
import ChangeDetail from "./ChangeDetail-fcd20a9b.mjs";
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 mt-3 lg:flex-row", children: [
        /* @__PURE__ */ jsxs(Card, { className: "w-full", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-end justify-center gap-2 mx-auto mb-3", children: (data == null ? void 0 : data.status) !== "open" && /* @__PURE__ */ jsxs(Badge, { size: "lg", variant: "green", children: [
              "Status Pengajuan = ",
        ...
        auth.permissions.includes("unit pimpinan") && /* @__PURE__ */ jsxs(Card, { className: "w-full", children: [
