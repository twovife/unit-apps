...
import Create from "./Create-a8f22c35.mjs";
import BukuTransaksiTable from "./BukuTransaksiTable-c3cf283e.mjs";
...
import Rencana from "./Rencana-672b469a.mjs";
import BukuTransaksiNextTable from "./BukuTransaksiNextTable-d523366e.mjs";
  ...
  return /* @__PURE__ */ jsxs(Authenticated, { header: /* @__PURE__ */ jsx(Head, { children: "Buku Transaksi" }), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "max-h-[70vh] border rounded-lg overflow-auto scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-thin", children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "bukutransaksi", className: "w-full", children: [
      /* @__PURE__ */ jsxs(TabsList, { children: [
        ...
        /* @__PURE__ */ jsx(TabsTrigger, { value: "dailyTarget", children: "Target Harian" })
      ] }),
      /* @__PURE__ */ jsxs(TabsContent, { value: "bukutransaksi", children: [
        /* @__PURE__ */ jsx(BukuTransaksiTable, { datas }),
        /* @__PURE__ */ jsx(BukuTransaksiNextTable, { datas: pengajuan_next })
      ] }),
