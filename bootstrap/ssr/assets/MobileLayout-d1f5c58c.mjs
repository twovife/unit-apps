...
import { S as SweetAlert, D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, e as DropdownMenuItem } from "./SweetAlert-03f33995.mjs";
  ...
  return /* @__PURE__ */ jsx(
    Sheet,
    {
      ...
      children: /* @__PURE__ */ jsx(SheetContent, { children: /* @__PURE__ */ jsxs(SheetHeader, { children: [
        ...
        /* @__PURE__ */ jsx(SheetDescription, { children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 p-3", children: /* @__PURE__ */ jsxs("div", { className: "w-full text-center", children: [
          /* @__PURE__ */ jsx(
            Button,
            {
              type: "button",
              ...
              size: "iconxl",
              variant: "destructive",
              children: /* @__PURE__ */ jsx(Link, { href: route("mobile_apps.index"), children: /* @__PURE__ */ jsx(Home, {}) })
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "text-center", children: "Home" })
        ] }) }) })
      ] }) })
    }
  );
...
const MobileLayout = ({ header, children, loading = false }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative z-10 antialiased", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative h-screen px-2 mx-auto lg:px-4", children: [
      /* @__PURE__ */ jsx("div", { className: "sticky top-0 z-50 flex items-center h-12 gap-4 px-3 bg-transparent", children: /* @__PURE__ */ jsxs("nav", { className: "flex flex-row items-center justify-between w-full gap-5 text-sm font-mediumlg:gap-6 backdrop-blur", children: [
