              ...
              <React.Fragment key={i}>
                ...
                {row.data.map((subrow, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell>{subrow.nik}</TableCell>
                    <TableCell>
                      {subrow.lunas ? (
                    ...
                    <TableCell>{subrow.kelompok}</TableCell>
                    <TableCell>{subrow.hari}</TableCell>
                    <TableCell>{subrow.pinjaman_ke}</TableCell>
                    <TableCell>{subrow.x_angs}</TableCell>
