    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center items-center gap-6 flex-wrap">
                ...
                <Link className="w-32 h-32 rounded p-3 flex flex-col justify-center items-center shadow hover:shadow-md focus:shadow-lg bg-gray-50/40 backdrop-blur border border-gray-200">
