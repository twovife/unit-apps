          ...
          <div className="mb-3">
            <div className="mb-3">
              <div className="flex">
                ...
                <div className="flex-[5]">{nikData?.[0]?.customer_name}</div>
              </div>
              <div className="flex mb-3">
                <div className="flex-[3]">NIK</div>
                <div className="flex-1">:</div>
                <div className="flex-[5]">{nikData?.[0]?.nik}</div>
              </div>
            </div>
            <div className="overflow-auto rounded shadow-sm max-h-[50vh] border-b-2">
              <table className="w-full text-sm border">
                <thead className="bg-gray-200">
                  <tr>
                    <td className="px-2 py-1">Tgl Drop</td>
                    <td className="px-2 py-1">Total Drop</td>
                    <td className="px-2 py-1">Lunas</td>
                    ...
                    nikData.map((item, key) => (
                      <tr key={key} className="even:bg-gray-100">
                        <td className="px-2 py-1">
                          {item.tanggal_drop
                            ? dayjs(item.tanggal_drop).format('DD-MM-YY')
                            : ''}
                        </td>
                        <td className="px-2 py-1">
                          <NumericFormat
                        ...
                        <td className="px-2 py-1">{item.lunas}</td>
