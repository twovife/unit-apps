...
export default function PrimaryButton({
    ...
    return (
        <button
            ...
            type={type}
            className={
                `inline-flex items-center px-4 ${sizeButton()} py-2 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest focus:outline-hidden focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150 ${
                    disabled && "opacity-25"
                }` + className
            }
            disabled={disabled}
